        ...
        <div class="row-fluid">
            ...
            <div class="span9" id="content">
                <div class="row-fluid">
				    ...
				    <ul class="breadcrumb">
						...
						<li><a href="#"><b>Tambah Materi Tambahan</b></a></li>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">		
							<input name="uploaded_file"  class="input-file uniform_on" id="fileInput" type="file" accept=".doc,.docx,.pdf,.ppt,.pptx,.xls,.xlsx" required>
			...
			jQuery(document).ready(function($){
				$("#add_downloadble").submit(function(e){
					$.jGrowl("Upload File Sedang Berlangsung. Mohon Tunggu......", { sticky: true });
					e.preventDefault();
					var _this = $(e.target);
					...
					$.ajax({
						...
						success: function(html){
							$.jGrowl("File Yang Diupload Berhasil Ditambahkan", { header: 'File Berhasil Ditambahkan' });
					...
					<div class="span8">					
						<div class="alert alert-info">Pilih kelas yang anda ingin bagikan file ini.</div>
