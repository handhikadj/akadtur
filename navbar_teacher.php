<div class="navbar navbar-fixed-top navbar-inverse">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="#">Selamat Datang di: E - Learning SAKURA PUTIH</a>
				<div class="nav-collapse collapse">
					<ul class="nav pull-right">
						<?php $query= mysqli_query($db, "select * from teacher where teacher_id = '$session_id'")or die(mysqli_error($db));
							...
							<a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user icon-large"></i><?php echo $row['firstname']." ".$row['lastname'];  ?> <i class="caret"></i></a>
								<ul class="dropdown-menu">
									<li>
										...
										<a tabindex="-1" href="#myModal" data-toggle="modal"><i class="icon-picture"></i> Ubah Avatar</a>
