            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
					    ...
					    <ul class="breadcrumb">
							...
							<li><a href="#"><b>Tugas Yang Terupload</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<?php
										$query1 = mysqli_query($db, "select * FROM assignment where assignment_id = '$post_id'")or die(mysqli_error($db));
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
                              		...
                              		<?php
										...
										where assignment_id = '$post_id'  order by assignment_fdatein DESC")or die(mysqli_error($db));
