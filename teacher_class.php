...
?>
		<li id="del<?php echo $id; ?>">
			...
			<a href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-trash"></i> Hapus Kelas</a>	
		
		</li>
		<?php include("delete_class_modal.php"); ?>
	<?php } }else{ ?>
		<div class="alert alert-info"><i class="icon-info-sign"></i> Saat Ini Tidak Ada Kelas Yang Ditambahkan</div>
	<?php } ?>
</ul>