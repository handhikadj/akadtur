                ...
                <div class="row-fluid">
                    ...
                    <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
							...
							?>
                            <div id="" class="muted pull-left"><span class="badge badge-info"><?php echo $count; ?></span></div>
                        </div>
                        ...
                        <div class="block-content collapse in">
                            <div id="downloadable_table.php" class="span12">
								...
								<?php
									...
									if ($count == '0'){ ?>
								<div class="alert alert-info"><i class="icon-info-sign"></i> Saat ini anda belum mengunggah materi tambahan apapun.</div>
