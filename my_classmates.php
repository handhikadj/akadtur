        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
					     <!-- breadcrumb -->
					<?php $query = mysqli_query($db, "select * from teacher_class_student
					...
					?>
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Teman Sekelas Saya</b></a></li>
						</ul>
                                ...
                                <div class="span12">
									<ul	 id="da-thumbs" class="da-thumbs">
										    <?php
														...
														$my_student = mysqli_query($db, "SELECT *
														FROM teacher_class_student
														LEFT JOIN student ON student.student_id = teacher_class_student.student_id
														INNER JOIN class ON class.class_id = student.class_id where teacher_class_id = '$get_id' order by lastname ")or die(mysqli_error($db));
