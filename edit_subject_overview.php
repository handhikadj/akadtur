					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php 
								$subject_query = mysqli_query($db, "select * from class_subject_overview where  class_subject_overview_id  = '$subject_id'")or die(mysqli_error($db));
								...
								?>
										...
										mysqli_query($db, "update class_subject_overview set content = '$content' where class_subject_overview_id = '$subject_id'")or die(mysqli_error($db));
										?>
										<script>
