	...
	<div class="modal-header">
		...
		<h3 id="myModalLabel">Hapus Pertanyaan?</h3>
	</div>
	<div class="modal-body">
		<div class="alert alert-danger">
		<p>Apa anda yakin ingin menghapus Pertanyaan yang anda pilih?.</p>
		</div>
	</div>
	<div class="modal-footer">
		<button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i> Tutup</button>
		<button name="backup_delete" class="btn btn-danger"><i class="icon-check icon-large"></i> Ya</button>
	</div>
	</div>