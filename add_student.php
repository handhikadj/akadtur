							...
							<div class="span12">
								<form method="post" action="">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
											...
											$a = 0 ;
											$query = mysqli_query($db, "select * from student LEFT JOIN class on class.class_id = student.class_id
								...
								if (isset($_POST['submit'])){
									...
									for($b = 1; $b <=  $test; $b++)
									{
										...
										$query = mysqli_query($db, "select * from teacher_class_student where student_id = '$id' and teacher_class_id = '$class_id' ")or die(mysqli_error($db));
										...
										if($Add == 'Add'){
											...
											mysqli_query($db, "insert into teacher_class_student (student_id,teacher_class_id,teacher_id) values('$id','$class_id','$teacher_id') ")or die(mysqli_error($db));
