                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-right">
									<?php
										$query = mysqli_query($db, "select * from teacher_class_student
												 LEFT JOIN teacher_class ON teacher_class.teacher_class_id = teacher_class_student.teacher_class_id 
												 LEFT JOIN class ON class.class_id = teacher_class.class_id 
												 LEFT JOIN subject ON subject.subject_id = teacher_class.subject_id
												 LEFT JOIN teacher ON teacher.teacher_id = teacher_class.teacher_id
												 where student_id = '$session_id' ")or die(mysqli_error($db));
										// $query = mysqli_query($db, "select * from teacher_class_student
										// 		 LEFT JOIN teacher_class ON teacher_class.teacher_class_id = teacher_class_student.teacher_class_id 
										// 		 LEFT JOIN class ON class.class_id = teacher_class.class_id 
										// 		 LEFT JOIN subject ON subject.subject_id = teacher_class.subject_id
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<?php }}else{ ?>
									<div class="alert alert-info"><i class="icon-info-sign"></i> Saat ini anda tidak mengikuti kelas manapun</div>
									<?php } ?>	
									</ul>
