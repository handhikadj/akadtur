...
<body>
    ...
    <div class="container-fluid">
                            ...
                            <div class="span12">
						    	...
						    	<form class="form-horizontal" method="post">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="number" class="span1" name="points" min=1 max=5 required> <!-- Min:1 Max:5 -->
										</div>
									</div>
		...
		if (isset($_POST['save'])){
			...
			if ($type  == '2'){
				mysqli_query($db, "insert into quiz_question (quiz_id,question_text,date_added,answer,question_type_id) 
				values('$get_id','$question',NOW(),'".$_POST['correctt']."','$type')")or die(mysqli_error($db));
