<form id="email_student" class="form-signin" method="post">
	<h3 class="form-signin-heading"><i class="icon-lock"></i> Daftar Sebagai Guru</h3>
	<input type="text" class="input-block-level" name="email_student" placeholder="Email" required>
	<button id="signin_emailt" name="submit_email_student" class="btn btn-info" type="submit"><i class="icon-check icon-large"></i> Daftar</button>
</form>

<form id="signin_student_form" class="form-signin signin_student_hide" method="post">
	<h3 class="form-signin-heading"><i class="icon-lock"></i> Daftar Sebagai Guru</h3>
