							...
							<!-- block -->
		                        <div class="block">
									...
									<a href="content.php"><i class="icon-arrow-left"></i> Back</a>
									   <?php
									   $query = mysqli_query($db, "select * from content where content_id = '$get_id'")or die(mysqli_error($db));
									   ...
									   <form class="form-horizontal" method="POST">
										...
										mysqli_query($db, "update content set title = '$title' , content = '$content' where content_id = '$get_id'")or die(mysqli_error($db));
										?>
										<script>
