        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
					 <a href="add_content.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Tambah Konten</a>
                        <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Daftar Konten</div>
                            </div>
             		...
             		<?php
					$content_query = mysqli_query($db, "select * from content ORDER BY title ASC")or die(mysqli_error($db));
