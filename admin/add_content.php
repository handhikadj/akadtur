							...
							<!-- block -->
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Tambah Konten</div>
		                            </div>
									...
									<a href="content.php"><i class="icon-arrow-left"></i> Kembali</a>
									   ...
									   <form class="form-horizontal" method="POST">
										...
										<button name="save" type="submit" class="btn btn-info"><i class="icon-save icon-large"></i> Simpan</button>
										</div>
										</div>
										</form>
										...
										mysqli_query($db, "insert into content (title,content) value('$title','$content')")or die(mysqli_error($db));
										?>
										<script>
