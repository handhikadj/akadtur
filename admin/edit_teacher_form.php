...
<div class="control-group">
	<div class="controls">
		<input class="input focused" value="<?php echo $row['name']; ?>" name="name" id="focusedInput" type="text" placeholder = "Nama Lengkap">
	</div>
</div>									
...
if (isset($_POST['update'])) {
	...
	$query = mysqli_query($db, "select * from teacher where name = '$name' ")or die(mysqli_error($db));
