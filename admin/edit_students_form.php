       ...
       <a href="students.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Tambah Siswa</a>
                        ...
                        <div class="block">
							...
							?>
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input name="un" value="<?php echo $row['username']; ?>" class="input focused" id="focusedInput" type="text" placeholder = "ID Siswa" required>
                                          </div>
                                        </div>
	      ...
	      <?php
                            if (isset($_POST['update'])) {
								...
								mysqli_query($db, "update student set username = '$un' , firstname ='$fn' , lastname = '$ln' , class_id = '$cys' where student_id = '$get_id' ")or die(mysqli_error($db));
